...
--DECLARE @Nhanvien_tpHCM TABLE (MaNV NVARCHAR(9), TenNV NVARCHAR(15))
----chen du lieu
--INSERT INTO @Nhanvien_tpHCM
--SELECT MaNV, TenNV FROM dbo.NHANVIEN WHERE DCHI LIKE '%HCM'

--SELECT * FROM @Nhanvien_tpHCM

SELECT CHARINDEX(' S','SQL Sever')